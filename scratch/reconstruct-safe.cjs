...
// Need to remove the original closing bracket of the map since we replaced it with the placeholder
content = content.replace(
  /<\/div>\n        \);\n      \}\)}\n\n      \{\/\* Empty state \*\/\}/,
  '\n      {/* Empty state */}'
);
